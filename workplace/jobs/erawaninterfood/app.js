  ...
  function renderMyanmarForm(copy) {
    return `
      <div class="field-card p-4 sm:p-6">
        ...
        <div class="mt-5 grid gap-5">
          ${renderTextField({ id: 'my-name', label: 'အမည်', labelSecondary: 'Name (ENGLISH ONLY)', required: true, placeholder: 'Enter name in English', pattern: "[A-Za-z](?:[A-Za-z .'-]*[A-Za-z])?", title: 'Please enter your name using English letters only.' })}
